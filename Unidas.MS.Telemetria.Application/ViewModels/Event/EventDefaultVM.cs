...
namespace Unidas.MS.Telemetria.Application.ViewModels.Event
{
    ...
    public class EventDefaultDatum
    {
        ...
        public bool? rastreadorBateriaInternaAtiva { get; set; }
        public bool? rastreadorBateriaInternaTensao { get; set; }
        ...
        public bool? bateriaExternaAtiva { get; set; }
        public bool? bateriaExternaTensao { get; set; }
