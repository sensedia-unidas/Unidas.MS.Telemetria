...
{
    public class IturanQueueReadUseCase : BaseQueueReadUseCase, IIturanQueueReadUseCase
    {
        public IturanQueueReadUseCase(IIturanServiceBusService serviceBusService) : base(serviceBusService)
        {
        }
    }
}
